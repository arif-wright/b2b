...
<body>
      ...
      <img src="images/cor.png" style="width:50%">
			...
			<h1>Portal Login</h1>
			<form action= "includes/signup.inc.php" method="post" name="Please Sign In">
                <label for="name">
					<i class="fas fa-user"></i>
				</label>
				<input type="text" name="name" placeholder="First Name" id="name" pattern="[a-zA-Z0-9]+" required />
                <label for="username">
					<i class="fas fa-user"></i>
				</label>
				...
				<input type="password" name="pwdrepeat" placeholder="Repeat Password" id="password" required />
                <label for="email">
					<i class="fas fa-user"></i>
				</label>
